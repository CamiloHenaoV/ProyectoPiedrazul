...
@DisplayName("EstadoCanceladaHandler")
class EstadoCanceladaHandlerTest {

    private EstadoCanceladaHandler handler;

    @BeforeEach
    void setUp() {
        handler = new EstadoCanceladaHandler();
    }

    @Test
    @DisplayName("getEstado() debe retornar EstadoCita.cancelada")
    void getEstado_retornaCancelada() {
        assertThat(handler.getEstado()).isEqualTo(EstadoCita.cancelada);
    }
    ...
    @Test
    @DisplayName("cancelar() sobre cita cancelada lanza TransicionEstadoInvalidaException")
    ...
    @Test
    @DisplayName("cancelar() informa estadoActual=cancelada en la excepción")
    void cancelar_excepcionContieneEstadoActual() {
        ...
        assertThatThrownBy(() -> handler.cancelar(cita))
                ...
                .satisfies(ex -> {
                    ...
                    assertThat(t.getEstadoActual()).isEqualTo(EstadoCita.cancelada);
                });
    }
    ...
    @Test
    @DisplayName("completar() sobre cita cancelada lanza TransicionEstadoInvalidaException")
    ...
    @Test
    @DisplayName("completar() informa estadoActual=cancelada en la excepción")
